...
public class LO extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int id1 = context.getResources().getIdentifier("lo_"+Integer.toString(picN1), "drawable", context.getPackageName());
        pic1.setImageResource(id1);

        int id2 = context.getResources().getIdentifier("lo_"+Integer.toString(picN2), "drawable", context.getPackageName());
        pic2.setImageResource(id2);

        int id3 = context.getResources().getIdentifier("lo_"+Integer.toString(picN3), "drawable", context.getPackageName());
        pic3.setImageResource(id3);

        int id4 = context.getResources().getIdentifier("lo_"+Integer.toString(picN4), "drawable", context.getPackageName());
        pic4.setImageResource(id4);

        int id5 = context.getResources().getIdentifier("lo_"+Integer.toString(picN5), "drawable", context.getPackageName());
    ...
    public void Q1(View v){
        ...
        databaseAccess.open();
        String val1 = databaseAccess.getValue("lo_"+Integer.toString(picN1));
    ...
    public void Q2(View v){
        ...
        DatabaseAccess databaseAccess = DatabaseAccess.getInstance(getApplicationContext());
        databaseAccess.open();
        String val2 = databaseAccess.getValue("lo_"+Integer.toString(picN2));
    ...
    public void Q3(View v){
        ...
        DatabaseAccess databaseAccess = DatabaseAccess.getInstance(getApplicationContext());
        databaseAccess.open();
        String val3 = databaseAccess.getValue("lo_"+Integer.toString(picN3));
    ...
    public void Q4(View v){
        ...
        DatabaseAccess databaseAccess = DatabaseAccess.getInstance(getApplicationContext());
        databaseAccess.open();
        String val4 = databaseAccess.getValue("lo_"+Integer.toString(picN4));
    ...
    public void Q5(View v){
        ...
        DatabaseAccess databaseAccess = DatabaseAccess.getInstance(getApplicationContext());
        databaseAccess.open();
        String val5 = databaseAccess.getValue("lo_"+Integer.toString(picN5));
